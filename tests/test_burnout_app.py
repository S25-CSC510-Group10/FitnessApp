...
# # Test chatbot handling of unknown inputs
# def test_chatbot_unknown_input(client, mock_user, monkeypatch):
#     def mock_chat_response(message):
#         return "I'm not sure how to respond to that."

#     monkeypatch.setattr("your_chatbot_module.get_response", mock_chat_response)

#     with client.session_transaction() as sess:
#         sess["email"] = mock_user["email"]

#     response = client.post("/chatbot", json={"message": "qwerty123"})
#     assert response.status_code == 200
#     assert b"I'm not sure how to respond to that." in response.data


# # Test chatbot handling of long messages
# def test_chatbot_long_message(client, mock_user, monkeypatch):
#     long_message = "a" * 500  # Simulating a long input

#     def mock_chat_response(message):
#         return "That's a long message! Let me summarize."
...
#     response = client.post("/chatbot", json={"message": long_message})
#     assert response.status_code == 200
#     assert b"That's a long message! Let me summarize." in response.data


# # Test chatbot handling of special characters
# def test_chatbot_special_characters(client, mock_user, monkeypatch):
#     def mock_chat_response(message):
#         return "I see you used special characters!"
...
#     assert response.status_code == 200
#     assert b"I see you used special characters!" in response.data


# # Test chatbot handling of numeric input
# def test_chatbot_numeric_input(client, mock_user, monkeypatch):
#     def mock_chat_response(message):
#         return "Numbers detected! Do you need calculations?"
...
#     response = client.post("/chatbot", json={"message": "12345"})
#     assert response.status_code == 200
#     assert b"Numbers detected! Do you need calculations?" in response.data


# # Test chatbot handling of greetings
# def test_chatbot_greeting(client, mock_user, monkeypatch):
#     def mock_chat_response(message):
...
#     assert response.status_code == 200
#     assert b"Hello! How can I assist you today?" in response.data


# # Test chatbot handling of multiple messages in sequence
# def test_chatbot_multiple_messages(client, mock_user, monkeypatch):
#     responses = iter(["Hello!", "I'm a chatbot.", "What else can I help with?"])

#     def mock_chat_response(message):
#         return next(responses, "Goodbye!")
...
#     response1 = client.post("/chatbot", json={"message": "Hi"})
#     response2 = client.post("/chatbot", json={"message": "What are you?"})
#     response3 = client.post("/chatbot", json={"message": "Tell me more"})

#     assert response1.status_code == 200
#     assert b"Hello!" in response1.data
#     assert response2.status_code == 200
#     assert b"I'm a chatbot." in response2.data
#     assert response3.status_code == 200
#     assert b"What else can I help with?" in response3.data
